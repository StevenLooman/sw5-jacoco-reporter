...
public final class TestData {
  ...
  public static final File JACOCO_EXEC_FILE =
      Path.of("src/test/resources/fixture_product/jacoco.exec").toFile();
  ...
  /**
   * Get SwJarAnalyzerReader for fixture data.
   *
   * @return {@link SwJarAnalyzerReader}.
   * @throws IOException -
   */
  ...
  /**
   * Get SwJarAnalyzerAnalyzer for fixture data.
   *
   * @return {@link SwJarAnalyzerAnalyzer}.
   * @throws IOException -
   */
  public static SwJarAnalyzerAnalyzer getLibAnalyzer() throws IOException {
    ...
    return new SwJarAnalyzerAnalyzer(libReader);
  }

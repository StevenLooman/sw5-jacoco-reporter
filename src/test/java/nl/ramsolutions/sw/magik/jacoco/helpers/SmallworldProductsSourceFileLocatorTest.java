...
class SmallworldProductsSourceFileLocatorTest {
  ...
  void testGetSourceFile() throws IOException {
    ...
    final SmallworldProductsSourceFileLocator locator =
  ...
  void testGetNonMagikSourceFile() throws IOException {
    ...
    final SmallworldProductsSourceFileLocator locator =
        new SmallworldProductsSourceFileLocator(smallworldProducts);
    final Reader reader =
        locator.getSourceFile(
            "nl/ramsolutions/sw/magik/jacoco/helpers", "SmallworldProductsSourceFileLocator.java");

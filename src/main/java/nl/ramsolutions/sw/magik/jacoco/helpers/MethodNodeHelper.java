...
public final class MethodNodeHelper {
  ...
  private static final String ANNOTATION_CODE_TYPE =
      "Lcom/gesmallworld/magik/commons/runtime/annotations/CodeType;";
  private static final List<String> ANNOTATION_VALUE_TOP_LEVEL = List.of("value", "TopLevel");
  private static final String ANNOTATION_PARENT =
      "Lcom/gesmallworld/magik/commons/runtime/annotations/Parent;";
  ...
  public static String getParentMethodName(final MethodNode methodNode) {
    final AnnotationNode parentMethodAnnotationNode =

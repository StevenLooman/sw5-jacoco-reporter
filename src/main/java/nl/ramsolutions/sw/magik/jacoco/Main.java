...
public final class Main {
  ...
  private static final Option OPTION_HELP =
      Option.builder().longOpt("help").desc("Show this help").build();
  private static final Option OPTION_PRODUCT_PATH =
      Option.builder()
          ...
          .build();
  private static final Option OPTION_SOURCE_PATH =
      Option.builder()
          .longOpt("source-path")
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_JACOCO_FILE =
      Option.builder()
          .longOpt("jacoco-file")
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_DISCARD_EXECUTABLE =
      Option.builder().longOpt("discard-executable").desc("Discard executable classes").build();
  private static final Option OPTION_DISCARD_NON_MAGIK =
      Option.builder().longOpt("discard-non-magik").desc("Discard non-Magik sources").build();
  private static final Option OPTION_HTML =
      Option.builder()
          .longOpt("html")
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_JACOCO_XML =
      Option.builder()
          .longOpt("jacoco-xml")
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_SONAR_XML =
      Option.builder()
          .longOpt("sonar-xml")
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_COBERTURA_XML =
      Option.builder()
          ...
          .type(PatternOptionBuilder.FILE_VALUE)
          .build();
  private static final Option OPTION_BUNDLE_NAME =
      Option.builder()
          .longOpt("bundle-name")
  ...
  public static void main(String[] args) throws IOException, ParseException {
    ...
    final String bundleName =
        commandLine.hasOption(OPTION_BUNDLE_NAME)
    ...
    if (commandLine.hasOption(OPTION_HTML)) {
      ...
      final JacocoXmlReportGenerator xmlReportGenerator =
      ...
      final SonarXmlReportGenerator sonarXmlReportGenerator =
          new SonarXmlReportGenerator(
              productPaths,
              sourcePaths,
              executionDataFile,
              outputFile,
      ...
      final CoberturaXmlReportGenerator coberturaXmlReportGenerator =
          new CoberturaXmlReportGenerator(
              productPaths,
              sourcePaths,
              executionDataFile,
              outputFile,
